...
// Create a custom Form struct, which anonymously embeds a url.Values object (to hold the form data) and an Errors field to hold any validation errors from the form data.
type Form struct {
	url.Values
	Errors errors
}

// Define a New function to initialize a custom From struct. Notice that this takes the form data as the parameter?
